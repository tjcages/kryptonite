  ...
  renderMessages() {
    ...
    return messagesArray.map(messageCategory => {
      ...
      if (messageCategory.length) {
        category = messageCategory[0].labelIds.includes("CATEGORY_PROMOTIONS") ? "PROMOTIONS" : ""
        category = messageCategory[0].labelIds.includes("CATEGORY_UPDATES") ? "UPDATES" : ""
        category = messageCategory[0].labelIds.includes("CATEGORY_PERSONAL") ? "PERSONAL" : ""
      }
