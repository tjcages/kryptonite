...
export class MessageList extends PureComponent {
  ...
  renderMessages() {
    ...
    messages.sort((a, b) => {
      ...
      let aFromName = aFromHeader ? this.getFromName(fromHeader.value) : "undefined";

      const bFromHeader = b.payload.headers.find(el => el.name.toUpperCase() === "FROM");
      let bFromName = bFromHeader ? this.getFromName(fromHeader.value) : "undefined";

      console.log(a)
      console.log(aFromName)
      console.log(bFromName)
    })
