...
import Trend from '../../../assets/images/trend-up.svg'
...
export class MessageList extends PureComponent {
  ...
  componentDidMount() {
    ...
    console.log(this.props.parentLabel.id)
        ...
        <div>
          { category &&
            <div className="category">
              <img src={Trend} alt="Like" className="category-icon" />
              <h4>{category}</h4>
              <img src={ChevronDown} alt="Like" />
            </div>
          }
        {
