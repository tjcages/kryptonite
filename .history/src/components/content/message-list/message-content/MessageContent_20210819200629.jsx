...
export class MessageContent extends Component {
  ...
  render() {
    ...
    const headers = this.props.emailMessageResult.headers
    let formattedDate = ""
    let subject = ""
    let fromName = ""

    if (headers) {
      console.log(this.props.emailMessageResult.headers)
      const receivedHeader = this.props.emailMessageResult.headers.find(el => el.name.toUpperCase() === "X-RECEIVED");
      ...
      const subjectHeader = this.props.emailMessageResult.headers.find(el => el.name.toUpperCase() === "SUBJECT");
      subject = subjectHeader ? subjectHeader.value : "";
      const fromHeader = this.props.emailMessageResult.headers.find(el => el.name.toUpperCase() === "FROM");
