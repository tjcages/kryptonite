...
import { faSpinner, faReply } from "@fortawesome/free-solid-svg-icons";
      ...
      <React.Fragment>
        ...
        <div className="message-header">
          <div className="content-titles">
            ...
            <h4 className="from-name">{fromName}</h4>
            <p className="from-name">{formattedDate}</p>
          </div>
          <div className="content-actions">
            ...
            <div className="mr-2">
              <button className="action-btn flex row">
                <FontAwesomeIcon
                  title="Reply"
                  icon={faReply}
                  size="lg"
