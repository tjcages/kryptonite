  ...
  render() {
    ...
    return (
      <div className={`message-row d-flex table-row-wrapper${selected}`}>
        ...
        <div style={{overflow: 'hidden', background: 'yellow', minWidth: '200px', maxWidth: '400px', maxHeight: '200px'}}>
          <div 
            dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(body, { ADD_ATTR: ['target', 'style'] })}} 
            style={{transform: 'scale(0.5)', background: 'red', width: '600px', height: '200px'}}
          />
        </div>
