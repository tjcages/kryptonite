  ...
  render() {
    ...
    return (
      <div className={`message-row d-flex table-row-wrapper${selected}`}>
        ...
        <div style={{transform: 'scale(0.5)', overflow: 'hidden', background: 'yellow', minWidth: '600px', maxWidth: '600px', maxHeight: '600px'}}>
          <div 
            dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(body, { ADD_ATTR: ['target', 'style'] })}} 
            style={{background: 'red', width: '600px', height: '1200px'}}
          />
        </div>
