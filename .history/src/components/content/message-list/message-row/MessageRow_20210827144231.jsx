  ...
  render() {
    ...
    return (
      <div className={`message-row d-flex table-row-wrapper${selected}`}>
        ...
        <div style={{position: 'relative', overflow: 'hidden', minWidth: '200px', maxWidth: '400px', maxHeight: '200px'}}>
          <div 
            dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(body, { ADD_ATTR: ['target', 'style'] })}} 
            style={{position: 'absolute', top: 0, right: 0, left: 0, transform: 'scale(0.7)', background: 'red', width: '400px', height: '200px'}}
          />
        </div>
