    ...
    return (
      <div className={`message-row d-flex table-row-wrapper${selected}`}>
        ...
        <div
          ...
          className={`table-row py-3${unread}`}
        >
          <div style={{position: 'relative', overflow: 'hidden', minWidth: '100%', minHeight: '200px', maxHeight: '300px', border: '3px solid #efefef', borderRadius: '12px'}}>
            <div 
