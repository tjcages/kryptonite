...
export class MessageItem extends PureComponent {
  ...
  render() {
    ...
    const currentMessageId = this.props.location.pathname.replace(this.props.match.url, 'poop')
    const selected = this.props.data.id === currentMessageId ? " selected" : "";
    console.log(this.props)
    console.log("first: " + this.props.data.id)
    console.log("second: " + currentMessageId)
