  ...
  return (
    <div className="wrapper text-4">
      <div className="name-subject-fields text-2">
        <div className="d-flex flex-row name-fields">
          <h4 className="name-field h4">{props.fromName}</h4>
          <h4 className="name-field date h4"> • </h4>
          <h4 className="name-field date h4">{props.formattedDate}</h4>
        </div>
        <h3>{props.subject}</h3>
