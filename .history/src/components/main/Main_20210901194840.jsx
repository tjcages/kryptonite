...
export class Main extends Component {
  ...
  componentDidMount() {
    ...
    const messagesResult = this.props.messagesResult
    if (messagesResult && !messagesResult.messages.length) {
      this.getLabelList();
      console.log(this.props)
    }
  }
  ...
  renderInboxViewport() {
    ...
    return (
      <AnimateSharedLayout type="crossfade">
        <Fragment>
          <section className="main hbox justify-start">
            {/* <Sidebar
            ...
            <div className="dark-bar vertical" />
          </section>
          
          <AnimatePresence>
            <Route
              exact
              path="/:label/:id([a-zA-Z0-9]+)"
